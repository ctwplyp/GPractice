	...
	<body>
		...
		<div id="show-person" class="content scaffold-show" role="main">
			...
			<ol class="property-list person">
				...
				<g:if test="${personInstance?.companys}">
				<li class="fieldcontain">
					<span id="companys-label" class="property-label"><g:message code="person.companys.label" default="Companys" /></span>
					
						<span class="property-value" aria-labelledby="companys-label"><g:link controller="company" action="show" id="${personInstance?.companys?.id}">${personInstance?.companys?.encodeAsHTML()}</g:link></span>
